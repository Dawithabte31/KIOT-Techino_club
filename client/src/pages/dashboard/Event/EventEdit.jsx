...
import axios from "axios";
  const EventEdit = ({ eventId, onClose}) => {
  ...
  const [description, setDescription] = useState(event.desc);
  ...
  return (
    ...
    <input style={{ width: '100%', padding: '8px', marginBottom: '15px' }} placeholder={"FullName.."} defaultValue={event.title} autoFocus={true} type="text" onChange={(e) => setTitle(e.target.value)} />
    <label style={{ display: 'block', marginBottom: '5px' }}>Description:</label>
    <textarea style={{ width: '100%', padding: '8px', marginBottom: '15px' }} placeholder={"Description.."} type="textarea" defaultValue={event.desc} autoFocus={true}  onChange={(e) => setDescription(e.target.value) }></textarea>
